...
class Ui_SignalItem(object):
    def setupUi(self, SignalItem):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.qle_dataSource.sizePolicy().hasHeightForWidth())
        self.qle_dataSource.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.qle_dataID.sizePolicy().hasHeightForWidth())
        self.qle_dataID.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.qle_customID.sizePolicy().hasHeightForWidth())
        self.qle_customID.setSizePolicy(sizePolicy)
